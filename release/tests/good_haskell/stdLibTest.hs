...
prog :: [Instruction]
prog = [
		  Const 1450 RegA               {-Initial Return Addr-}
		, Push RegA
		...
		, Const 71 RegD                 {-Declaration of result(=0); Function main-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 33 RegD                 {-Declaration of i1(=1234); Function testIntToStr-}
		, Push RegD
		, Const 1234 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 37 RegD                 {-Declaration of i2(=0)-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 39 RegD                 {-Declaration of i3(=9876)-}
		, Push RegD
		, Const 9876 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 41 RegD                 {-Declaration of i4(=-10)-}
		, Push RegD
		, Const 10 RegA
		, Push RegA
		, Pop RegA
		...
		, Push RegA
		, Jump (Abs 1308)               {-Jump to function flipArray-}
		, Load (Addr 53) RegA
		, Store RegA (Addr 15)
		, Const 3 RegA
		, Store RegA (Addr 16)
		...
		, Const 55 RegA                 {-Result addr-}
		, Push RegA
		, Jump (Abs 1379)               {-Jump to function flipArray-}
		, Load (Addr 51) RegA
		, Store RegA (Addr 74)
		, Load (Addr 52) RegA
		, Store RegA (Addr 75)
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Load (Addr 20) RegA           {-Function intToStr-}
		, Push RegA
		, Const 0 RegA
		, Pop RegB
		...
		, Load (Addr 20) RegA
		, Store RegA (Addr 114)
		, Const 114 RegA                {-Base addr for (anon) array 1174919051-}
		, Store RegA (Addr 21)
		, Pop RegB                      {-Get Result addr-}
		, Pop RegC                      {-Get Return addr-}
		, Compute Lt RegB Zero RegD     {-Is Result addr valid?-}
		...
		, Store Zero (Addr 133)
		, Store Zero (Addr 134)
		, Const 62 RegD                 {-Declaration of i(=0)-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		, Const 63 RegD                 {-Declaration of j(=0)-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Load (Addr 43) RegA           {-Function printInt-}
		, Push RegA
		, Const 0 RegA
		, Pop RegB
		, Compute GtE RegB RegA RegA    {-i GtE 0-}
		...
		, Pop RegD
		, Store RegA (Deref RegD)
		, Const 50 RegD                 {-Declaration of i(=pos); For loop declaration-}
		, Push RegD
		, Load (Addr 48) RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		...
		, Branch RegD (Rel 2)
		, Jump (Ind RegC)               {-return-}
		, Load (Addr 64) RegA           {-Function printBool-}
		, Branch RegA (Rel 2)
		, Jump (Rel 13)
		, Const 36 RegA
		, Store RegA (Addr 145)
		...
		, Const 21 RegA
		, Store RegA (Addr 148)
		, Const 145 RegA                {-Base addr for (anon) array 1770876208-}
		, Store RegA (Addr 65)
		, Out RegA
		, Jump (Rel 14)
		, Const 22 RegA
		...
		, Const 21 RegA
		, Store RegA (Addr 153)
		, Const 149 RegA                {-Base addr for (anon) array 431618307-}
		, Store RegA (Addr 66)
		, Out RegA
		, Pop RegB                      {-Get Result addr-}
		, Pop RegC                      {-Get Return addr-}
		...
		, Branch RegD (Rel 2)
		, Jump (Ind RegC)               {-return-}
		, Load (Addr 11) RegA           {-Function boolToStr-}
		, Branch RegA (Rel 2)
		, Jump (Rel 18)
		, Const 36 RegA
		, Store RegA (Addr 154)
		...
		, Const 21 RegA
		, Store RegA (Addr 157)
		, Const 154 RegA                {-Base addr for (anon) array 454547627-}
		, Store RegA (Addr 12)
		, Pop RegB                      {-Get Result addr-}
		, Pop RegC                      {-Get Return addr-}
		, Compute Lt RegB Zero RegD     {-Is Result addr valid?-}
		...
		, Const 21 RegA
		, Store RegA (Addr 162)
		, Const 158 RegA                {-Base addr for (anon) array 1900971551-}
		, Store RegA (Addr 13)
		, Pop RegB                      {-Get Result addr-}
		, Pop RegC                      {-Get Return addr-}
		, Compute Lt RegB Zero RegD     {-Is Result addr valid?-}
		...
		, Const 0 RegA
		, Store RegA (Addr 163)
		, Const 163 RegA                {-Base addr for (anon) array 975521494-}
		, Store RegA (Addr 14)
		, Pop RegB                      {-Get Result addr-}
		, Pop RegC                      {-Get Return addr-}
		, Compute Lt RegB Zero RegD     {-Is Result addr valid?-}
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Load (Addr 67) RegA           {-Function boolToInt-}
		, Branch RegA (Rel 2)
		, Jump (Rel 8)
		, Const 1 RegA
		, Pop RegB                      {-Get Result addr-}
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 77 RegD                 {-Declaration of i(=0); For loop declaration; Function arraysEqual-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		, Load (Addr 77) RegA           {-For loop condition-}
		, Push RegA
		, Load (Addr 76) RegA
		, Pop RegB
		, Compute GtE RegB RegA RegA    {-i Lt len-}
		, Branch RegA (Rel 32)          {-Break from for loop-}
		, Load (Addr 74) RegE           {-For loop body-}
		, Load (Addr 77) RegA
		, Compute Add RegE RegA RegD
		, Load (Deref RegD) RegA
		, Push RegA
		...
		, Store RegA (Deref RegB)       {-Store Result-}
		, Jump (Ind RegC)               {-return-}
		, Const 77 RegD                 {-i = i+1; For loop assignment-}
		, Push RegD
		, Load (Addr 77) RegA
		, Push RegA
		, Const 1 RegA
		...
		, Out RegA
		, Const 70 RegD                 {-Declaration of i(=0); For loop declaration-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		, Load (Addr 70) RegA           {-For loop condition-}
		, Push RegA
		, Load (Addr 69) RegA
		, Push RegA
		, Const 1 RegA
		...
		, Load (Addr 68) RegE           {-For loop body-}
		, Load (Addr 70) RegA
		, Compute Add RegE RegA RegD
		, Load (Deref RegD) RegA
		, Store RegA (Addr 43)
		...
		, Compute Sub Zero RegA RegA
		, Out RegA
		, Const 70 RegD                 {-i = i+1; For loop assignment-}
		, Push RegD
		, Load (Addr 70) RegA
		, Push RegA
		, Const 1 RegA
		...
		, Branch RegD (Rel 2)
		, Jump (Ind RegC)               {-return-}
		, Const 3 RegD                  {-Declaration of i(=0); Function flipArray-}
		, Push RegD
		, Const 0 RegA
		, Pop RegD
		, Store RegA (Deref RegD)
		, Const 4 RegD                  {-Declaration of j(=len-1)-}
		, Push RegD
		, Load (Addr 2) RegA
		, Push RegA
		, Const 1 RegA
		...
		, Branch RegA (Rel 47)
		, Const 5 RegD                  {-Declaration of t(=arr[j])-}
		, Push RegD
		, Load (Addr 1) RegE
		, Load (Addr 4) RegA
		, Compute Add RegE RegA RegD
