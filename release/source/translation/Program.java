...
public class Program {
	...
	/**
	 * Constructor Program is used to set the instance variables of a Program.
	 * 
	 * @param name
	 *            The name that needs to be set.
	 * @param coreCount
	 *            The coreCount that needs to be set.
	 */
	 ...
	 * 
	 * @return The list with instructions.
	 */
	 ...
	 * 
	 * @param instructions
	 *            The List with instructions that needs to be set.
	 */
	...
	/**
	 * getCoreCount() returns the amount of cores on which the program has to be
	 * run.
	 * 
	...
	/**
	 * setCoreCount() sets the amount of cores on which the program has to be
	 * run.
	 * 
	 * @param coreCount
	 *            The amount of cores of the program.
	 */
