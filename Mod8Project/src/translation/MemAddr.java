...
/**
 * A memory address. It can either be a constant address, or a register
 * containing one.
 * 
...
public class MemAddr implements Operand {
	 ...
	 * 
	 * @param reg
	 *            The Register which is to contain the required address.
	 */
	 ...
	 * 
	 * @param reg
	 *            The register which will contain the address.
